...
УВАЖНО! Через модифікації, що ми внесли у вихідний проєкт, а саме відсутність додаткового кроку з ручним вимкненням зарядного тракту ТР4056, можливий бекфід до транзисторного ключа, що може призвести до повного розряджання батареї, якщо залишити батарею у приладі на ніч! Через відсутність BMS на стандартній банці 18650, це може призвести до ПОВНОЇ розрядки батареї і виходу її з ладу.
